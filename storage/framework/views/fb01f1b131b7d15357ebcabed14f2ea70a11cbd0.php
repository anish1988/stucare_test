        ...
        <div class="modal-body p-4 bg-light">
          ...
          <div class="my-2">
            ...
            <select  name="company_id" id="company_id">
                ...
                <?php $__currentLoopData = $Company; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  ...
  <script>
    $(function() {
      ...
      $("#add_employee_form").submit(function(e) {
        ...
        console.log('<?php echo e(route('emp/store')); ?>');
        $.ajax({
          url: '<?php echo e(route('emp/store')); ?>',
          method: 'post',
          data: fd,
          cache: false,
          contentType: false,
      ...
      function fetchAllEmployees() {
        $.ajax({
          url: '<?php echo e(route('emp/fetchAll')); ?>',
          method: 'get',
          success: function(response) {
    ...
    $(document).on('click', '#show_employee_btn', function(e) {
      ...
      $("#edit_comp_form").submit(function(e) {
        ...
        $.ajax({
          url: '<?php echo e(route('comp_update')); ?>',
          method: 'post',
          data: fd1,
          cache: false,
          contentType: false,
...
</html><?php /**PATH /var/www/html/stucare_test/resources/views/index.blade.php ENDPATH**/ ?>